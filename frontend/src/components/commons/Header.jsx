  ...
  return (
    <div className='header-wrapper'>
      ...
      <nav className="sub-nav">
        <a href="/restaurant-list" className="sub-nav-link active">レストランとメニュー</a>
        <a href="/community" className="sub-nav-link">コミュニティー</a>
        <a href="/interesting" className="sub-nav-link">お気に入りの飲食店</a>
        <a href="/comment" className="sub-nav-link">評価を書く</a>
      </nav>
    </div>
  );
};
